...
<head>
    ...
    <meta name="description" content="Start your development with rahul.">
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Rahul</span>
            </h1>
        ...
        <div class="container text-center">
            ...
            <div class="about">
                ...
                <div class="about-caption">
                    ...
                    <a href="#section2" class="btn-rounded btn btn-outline-primary mt-4" download="feedback.pdf">Download CV</a>
                </div>
    ...
    <section class="section" id="contact">
        ...
        <div class="form-group">
            ...
            <textarea id="feed" class="form-control" name="feedback" placeholder="Enter your valuable feedback"></textarea>
        </div>
